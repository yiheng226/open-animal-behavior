"""
eval_swin3d.py — Evaluate a trained Video Swin-T model
...
def parse_args():
    p = argparse.ArgumentParser(description="Evaluate Video Swin-T model")
...
def main():
    ...
    print(f"\n{'='*80}")
    print("MODEL EVALUATION — Video Swin-T")
    print(f"{'='*80}")
